...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Bison_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("0f48145f-aea8-549d-8864-7f251ac1e6d0"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Bison", artifacts_toml) for e in artifacts["Bison"]]
...
if best_platform === nothing
    @debug("Unable to load Bison; unsupported platform $(triplet(platform_key_abi()))")
else
